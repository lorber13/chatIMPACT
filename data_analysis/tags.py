...
tag_carbon_emission = ['co2_eq_emissions'] # boolean... TODO: where are the values?
...
# TODO: check if complete (how?)
tag_domain = ['art','code','medical','legal','finance','biology','music','chemistry','climate']
